...
function Home() {
  ...
  return (
    <>
      <div className="p-28 flex flex-col gap-11">
          <div className="grid grid-cols-2">
            <div className="w-1/2">
              <p className="text-7xl tracking-widest leading-tight font-bold">Free Ai Assisted <span className="text-primary">AgendaKota</span> Generator</p>
            </div>
            <div className="">
          ...
          <div className="flex flex-col gap-4 mt-24">
              <div className=""><p className='font-bold text-5xl'>Free Tools</p></div>
              <div className="flex gap-8">
                <NavLink to="/hotel" className="h-72 w-full bg-primary p-10 rounded-sm flex gap-11 cursor-pointer">
                  <img src={FEATURED_ICON} alt="" width={'50px'} className='h-fit rounded-full bg-transparent' />
                  <div className="bg-transparent w-1/2">
                    <p className='bg-transparent text-white font-bold text-5xl leading-tight tracking-widest'>Generator Penawaran & Promosi Hotel</p>
                  </div>
                  <div className="bg-transparent ml-auto mt-auto">
                    <img src={ARROW_RIGHT} alt="" className='bg-transparent'/>
                  </div>
                </NavLink>
                <NavLink to="/event" className="h-72 w-full bg-primary p-10 rounded-sm flex gap-11 cursor-pointer">
                  <img src={FEATURED_ICON} alt="" width={'50px'} className='h-fit rounded-full bg-transparent' />
                  <div className="bg-transparent w-3/4">
                    <p className='bg-transparent text-white font-bold text-5xl leading-tight tracking-widest'>Generator Strategi Pemasaran & Promosi Event</p>
                  </div>
                  <div className="bg-transparent ml-auto mt-auto">
                    <img src={ARROW_RIGHT} alt="" className='bg-transparent'/>
                  </div>
